...
public interface AgentInteractionRepository extends JpaRepository<AgentInteractionEntity, Long> {
    ...
    @Query("select new HK.PrettyWorks_BE.agent.repository.AgentApprovalRow("
    ...
    @Query("select new HK.PrettyWorks_BE.agent.repository.AgentPendingApprovalRow(i.runId, i.id) "
