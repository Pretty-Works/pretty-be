...
public interface AgentMessageRepository extends JpaRepository<AgentMessageEntity, Long> {
    ...
    @Query("select new HK.PrettyWorks_BE.agent.conversation.persistence.projection.AgentMessageRow(" +
    ...
    @Query("select new HK.PrettyWorks_BE.agent.conversation.persistence.projection.AgentContextRow(m.role, m.content) " +
            "from AgentMessageEntity m " +
            "where m.conversationId = :conversationId " +
    ...
    @Query("select new HK.PrettyWorks_BE.agent.conversation.persistence.projection.AgentLastAgentMessageRow(" +
