...
public enum MeetingErrorCode implements ErrorCode {
    ...
    MEETING_NOT_FOUND(HttpStatus.NOT_FOUND, "MEETING_004", "존재하지 않는 회의록입니다."),
    AUTHOR_IN_ATTENDEES(HttpStatus.BAD_REQUEST, "MEETING_005", "작성자는 참석자에 포함될 수 없습니다."),
    DUPLICATE_ATTENDEE(HttpStatus.BAD_REQUEST, "MEETING_006", "참석자가 중복되었습니다."),
    MEETING_DATE_OUT_OF_RANGE(HttpStatus.BAD_REQUEST, "MEETING_007", "회의 일자가 프로젝트 기간을 벗어났습니다."),
    PROJECT_CLOSED(HttpStatus.BAD_REQUEST, "MEETING_008", "완료 또는 보관된 프로젝트에는 회의록을 추가/수정할 수 없습니다."),
    ...
    CANNOT_REMOVE_SELF(HttpStatus.BAD_REQUEST, "MEETING_011", "본인을 참석자 명단에서 제외할 수 없습니다.");
