...
public interface PostApi {
    ...
    @Operation(
            ...
            description = """
                    ...
                    - 검증 순서: 요청자 재직 상태(403) → 프로젝트 존재(404) → 참여중 멤버(403) → 프로젝트 상태(400)
                    """
    )
    @ApiResponses({
    ...
    @Operation(
            ...
            description = """
                    ...
                    - 수정된 최신 상세를 반환합니다.
                    - 검증 순서: 프로젝트 존재(404) → 참여중 멤버(403) → 게시글 존재·소속(404) → 작성자 권한(403) → 요청자 재직 상태(403) → 프로젝트 상태(400)
                    """
    )
    @ApiResponses({
    ...
    @Operation(
            ...
            description = """
                    ...
                    - 검증 순서: 프로젝트 존재(404) → 참여중 멤버(403) → 게시글 존재·소속(404) → 작성자 권한(403) → 요청자 재직 상태(403)
                    """
    )
    @ApiResponses({
