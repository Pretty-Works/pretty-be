...
INSERT INTO meetings
    (project_id, document_no, title, author_id, meeting_date, location, purpose, content, follow_up, created_at, modified_at)
VALUES
    (1,    'MTG-2026-001', '검색 고도화 킥오프',   1, '2026-06-05', '본사 3층 회의실 A', '프로젝트 범위·일정 합의', '범위, 역할, 마일스톤 확정',       '주간 스프린트 리뷰 운영', NOW(6), NOW(6)),
    (2,    'MTG-2026-002', '그룹웨어 리뉴얼 착수', 1, '2026-07-03', '본사 5층 회의실 B', '리뉴얼 착수 및 요구사항', '요구사항 우선순위 정리',         '디자인 시스템 선행',       NOW(6), NOW(6)),
    (NULL, 'MTG-2026-003', '전사 기획 정기회의',   5, '2026-07-10', '온라인(Zoom)',      '월간 기획 공유',           '부서별 진행상황 공유',           '차월 목표 수립',           NOW(6), NOW(6)),
    (1,    'MTG-2026-004', '검색 스프린트 리뷰',   2, '2026-07-22', '본사 3층 회의실 A', '스프린트 결과 리뷰',       '인덱싱/랭킹 개선 데모',         '벤치마크 리포트 공유',     NOW(6), NOW(6));
...
INSERT INTO schedules
    (user_id, title, start_at, end_at, all_day, created_at, modified_at)
VALUES
    (1, '주간 팀 미팅',        '2026-07-20 10:00:00', '2026-07-20 11:00:00', FALSE, NOW(6), NOW(6)),  -- 1
    (1, '검색팀 스프린트 리뷰', '2026-07-22 14:00:00', '2026-07-22 15:30:00', FALSE, NOW(6), NOW(6)),  -- 2
    (2, '기술 세미나',          '2026-07-24 16:00:00', '2026-07-24 17:00:00', FALSE, NOW(6), NOW(6)),  -- 3
    (4, '디자인 리뷰',          '2026-07-23 11:00:00', '2026-07-23 12:00:00', FALSE, NOW(6), NOW(6)),  -- 4
    (5, '전사 워크숍',          '2026-07-27 00:00:00', '2026-07-27 23:59:59', TRUE,  NOW(6), NOW(6)),  -- 5
    (8, '배포 점검',            '2026-07-25 20:00:00', '2026-07-25 22:00:00', FALSE, NOW(6), NOW(6)),  -- 6
    (3, '연차 휴가',            '2026-07-28 00:00:00', '2026-07-28 23:59:59', TRUE,  NOW(6), NOW(6)),  -- 7 (leave)
    (6, '병가',                 '2026-07-21 00:00:00', '2026-07-21 23:59:59', TRUE,  NOW(6), NOW(6));  -- 8 (leave)
